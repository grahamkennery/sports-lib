...
exports.StravaGPXTypes = exports.ActivityTypesMoving = exports.ActivityTypesGroupMapping = exports.ActivityTypeGroups = exports.ActivityTypes = exports.ActivityTypesHelper = void 0;
...
class ActivityTypesHelper {
    ...
    static averageSpeedDerivedDataTypesToUseForActivityType(activityType) {
        switch (ActivityTypesHelper.getActivityGroupForActivityType(activityType)) {
            case ActivityTypeGroups.Running:
                return [data_pace_avg_1.DataPaceAvg.type, data_grade_adjusted_pace_avg_1.DataGradeAdjustedPaceAvg.type];
    ...
    static altiDistanceSpeedDerivedDataTypesToUseForActivityType(activityType) {
        switch (ActivityTypesHelper.getActivityGroupForActivityType(activityType)) {
            case ActivityTypeGroups.Running:
                return [data_grade_adjusted_pace_1.DataGradeAdjustedPace.type];
            case ActivityTypeGroups.TrailRunning:
                return [data_grade_adjusted_pace_1.DataGradeAdjustedPace.type, data_grade_adjusted_speed_1.DataGradeAdjustedSpeed.type];
            default:
                return [];
        }
    }
    static verticalSpeedDerivedDataTypesToUseForActivityType(activityType) {
        switch (ActivityTypesHelper.getActivityGroupForActivityType(activityType)) {
            ...
            case ActivityTypeGroups.Performance:
                return [data_vertical_speed_1.DataVerticalSpeed.type];
            default:
                return [];
        }
    }
...
})(ActivityTypeGroups = exports.ActivityTypeGroups || (exports.ActivityTypeGroups = {}));
class ActivityTypesGroupMapping {
}
exports.ActivityTypesGroupMapping = ActivityTypesGroupMapping;
...
exports.ActivityTypesMoving = ActivityTypesMoving;
/**
...
class StravaGPXTypes {
}
exports.StravaGPXTypes = StravaGPXTypes;
