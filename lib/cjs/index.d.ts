...
export declare class SportsLib {
    /**
     ...
     */
    static importFromGPX(gpxString: string, domParser?: any, options?: ActivityParsingOptions): Promise<EventInterface>;
    /**
     * Parses and returns an event using TCX format
     * @param xmlDocument
     * @param options
     */
    static importFromTCX(xmlDocument: XMLDocument, options?: ActivityParsingOptions): Promise<EventInterface>;
    /**
     ...
     * @param options
     */
    static importFromSuunto(jsonString: string, options?: ActivityParsingOptions): Promise<EventInterface>;
    /**
