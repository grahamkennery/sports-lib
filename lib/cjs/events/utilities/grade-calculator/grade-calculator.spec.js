...
const grade_calculator_1 = require("./grade-calculator");
...
describe('GradeCalculator', () => {
    it('should align and squash distance & altitude along time', done => {
        ...
        // When
        const [squashedAlignedTime, squashedAlignedDist, squashedAlignedAlt] = grade_calculator_1.GradeCalculator.squashAlignStreams(timeData, distanceData, altitudeData);
        // Then
    ...
    describe('Grade compute', () => {
        it('should calculate grade on flat terrain', done => {
            ...
            // When
            const gradeStream = grade_calculator_1.GradeCalculator.computeGradeStream(timeData, distanceData, altitudeData);
            // Then
        ...
        it('should calculate grade on hilly terrain', done => {
            ...
            // When
            const gradeStream = grade_calculator_1.GradeCalculator.computeGradeStream(timeData, distanceData, altitudeData, 10, 50);
            // Then
            expect(gradeStream.length).toEqual(timeData.length);
    ...
    describe('Grade adjusted speed', () => {
        it('should model grade adjusted pace at grade of -32', () => {
            ...
            const grade = -30;
            // When
            const gradeAdjustedSpeed = grade_calculator_1.GradeCalculator.estimateAdjustedSpeed(speedMeterSeconds, grade);
            // Then
